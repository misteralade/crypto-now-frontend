...
import { X, Download, Smartphone, Info, ArrowRight } from "lucide-react";
import { deferredPrompt } from "../../pwa.ts";
...
const DISMISS_KEY = "cryptonow_pwa_install_dismissed";
...
interface PWAInstallBannerProps {
  /** Whether the banner is allowed to render */
  canShow?: boolean;
}

const PWAInstallBanner: React.FC<PWAInstallBannerProps> = ({ canShow = true }) => {
  ...
  useEffect(() => {
    // Check if we already have a deferred prompt from pwa.ts
    if (deferredPrompt) {
        ...
        >
          <div className="bg-white rounded-xl border border-gray-200 shadow-lg overflow-hidden">
            ...
            <button
              ...
              aria-label="Dismiss"
            >
              <X size={12} strokeWidth={1.5} className="text-gray-500" />
            </button>
