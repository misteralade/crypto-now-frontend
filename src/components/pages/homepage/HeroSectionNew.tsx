    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(ellipse, rgba(148,142,238,0.22) 0%, transparent 70%)",
          filter: "blur(48px)",
        }}
      />
      ...
      >
        <div
          ...
          style={{ border: "1px solid rgba(148,142,238,0.10)" }}
        />
        <div
          className="absolute rounded-full"
          style={{ inset: "80px", border: "1px solid rgba(148,142,238,0.13)" }}
        />
        <div
          className="absolute rounded-full"
          style={{ inset: "180px", border: "1px solid rgba(148,142,238,0.18)" }}
        />
      </div>
