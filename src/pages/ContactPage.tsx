...
const ContactPage = () => {
  ...
  return (
    <Fragment>
      <Navbar/>
      <main
        className="w-full md:w-[90%] 2xl:max-w-7xl mx-auto px-4 md:px-0 mt-[34px] mb-[30px] lg:mb-[121px] text-lg text-[#454745] flex md:flex-row flex-col gap-x-8 lg:gap-[51px] md:mt-24">
        {/* LHS */}
              ...
              <Form className="w-full">
                ...
                <div className="mt-4 relative">
                  ...
                  <div className="flex justify-between items-center mt-2">
                    <p className="text-xs text-gray-500">{values.message.length}/2000</p>
                ...
                <div className="mt-6 md:mt-12 flex justify-end">
                  <CustomButton
                    buttonText={isSubmitting ? "Sending Message..." : "Send Message"}
