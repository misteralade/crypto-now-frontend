...
export const TransactionStatus = z.preprocess(
  ...
  z.enum(['INITIATED', 'AWAITING_PAYMENT', 'IN_REVIEW', 'PROCESSING', 'AWAITING_CRYPTO', 'COMPLETED', 'FAILED', 'EXPIRED', 'CANCELLED', 'DISPUTED', 'REFUNDED', 'DEPOSIT_DETECTED', 'PENDING_CONFIRMATION', 'DEPOSIT_PENDING_MINIMUM', 'DEPOSIT_CONFIRMED', 'PAYOUT_INITIATED', 'PENDING_PAYOUT', 'PAYOUT_FAILED']),
);
