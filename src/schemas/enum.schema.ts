...
export const TransactionStatus = z.preprocess(
  ...
  z.enum(['INITIATED', 'AWAITING_PAYMENT', 'PROCESSING', 'AWAITING_CRYPTO', 'COMPLETED', 'FAILED', 'EXPIRED', 'CANCELLED', 'DISPUTED', 'REFUNDED', 'DEPOSIT_DETECTED', 'DEPOSIT_PENDING_MINIMUM', 'DEPOSIT_CONFIRMED', 'PAYOUT_INITIATED', 'PENDING_PAYOUT', 'PAYOUT_FAILED']),
);
