export const BASIC = {
  ...
  SENTRY_REPLAYS_SESSION_SAMPLE_RATE: Number(import.meta.env.VITE_SENTRY_REPLAYS_SESSION_SAMPLE_RATE || 0.1),
  SENTRY_REPLAYS_ON_ERROR_SAMPLE_RATE: Number(import.meta.env.VITE_SENTRY_REPLAYS_ON_ERROR_SAMPLE_RATE || 1),
}
