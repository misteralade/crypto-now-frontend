...
export function TransactionFilters({ onClose, filters, onFiltersChange, supportedCrypto }: TransactionFiltersProps) {
  ...
  const statusOptions = ['AWAITING_PAYMENT', 'IN_REVIEW', 'AWAITING_CRYPTO', 'DEPOSIT_DETECTED', 'DEPOSIT_PENDING_MINIMUM', 'DEPOSIT_CONFIRMED', 'PAYOUT_INITIATED', 'PENDING_PAYOUT', 'PAYOUT_FAILED', 'COMPLETED', 'FAILED', 'CANCELLED', 'EXPIRED', 'DISPUTED', 'REFUNDED'];
