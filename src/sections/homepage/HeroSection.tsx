  ...
  return (
    <section className="bg-white relative overflow-hidden">
      <div className="max-w-6xl mx-auto text-center mt-16">
        {/* Main heading */}
        <h1 className="text-5xl md:text-8xl font-bold text-[#0E0F0C] tracking-[4px]">
          Buy and Sell Crypto
        </h1>

        {/* Subheading with decorative underline */}
        <div className="relative">
          <div className="text-4xl md:text-8xl font-semibold text-[#BDBDBD] mb-8">
            Fast •{" "}
          ...
          <img className="absolute right-[5%] top-[30%]" src={Arrow} alt="" />
        </div>
        ...
        <div className="mt-12 flex items-center justify-center">
          <img className="w-[900px] h-[420px]" src={UserIllustration} alt="" />
        </div>
      </div>
      ...
      <div
        ...
        className="right-0 blur-[200px] top-[23%] z-[2] h-[450px] absolute w-[300px]"
      ></div>
    </section>
  );
}
